...
from src.friday.skills.email_skill import EmailSkill
from src.friday.skills.calendar_skill import CalendarSkill
from src.friday.skills.news_skill import NewsSkill
