...
class FridaySettings(BaseSettings):
    ...
    persona_stt_model: str = "vosk-model-small-en-us-0.15"
    persona_instructions: str = "You are Friday, a helpful, concise, and slightly witty AI assistant. Always reply directly and maintain a professional yet friendly tone."
    persona_verbosity: str = "concise" # concise, normal, detailed
